...
class TrainTimmingCard extends StatefulWidget {
  final String start;
  final String end;
  final List busList;
  final int index;
  const TrainTimmingCard({
    Key? key,
    required this.start,
    required this.end,
  ...
  @override
  State<TrainTimmingCard> createState() => _TrainTimmingCardState();
}

class _TrainTimmingCardState extends State<TrainTimmingCard> {
  List data = [];
